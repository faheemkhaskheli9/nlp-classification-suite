"""One-off local check: confirm the 2 source repos are actually archived.
...
`nlp-classification-suite`). The reusable detection logic this exercises is
...
from nlp_suite.archival import check_archival  # noqa: E402

SUITE_NAME = "nlp-classification-suite"
ORIGINALS = ["quora-insincere-classification", "multilingual-sentiment-analysis"]
